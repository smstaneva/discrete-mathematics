...
# Image data
image_data <- c("https://upload.wikimedia.org/wikipedia/commons/d/de/Galer%C3%ADa_Nacional%2C_Londres%2C_Inglaterra%2C_2014-08-07%2C_DD_035.JPG", "https://upload.wikimedia.org/wikipedia/commons/a/a8/London.bankofengland.arp.jpg", "https://upload.wikimedia.org/wikipedia/commons/6/64/Bankside_Gallery_%281%29.jpg", "https://upload.wikimedia.org/wikipedia/commons/d/d1/The_British_Museum_today.jpg", "https://upload.wikimedia.org/wikipedia/commons/1/11/Burgh_House_in_New_End_Square_-_geograph.org.uk_-_674944.jpg", "https://upload.wikimedia.org/wikipedia/commons/7/7a/Crafts_Council_building%2C_Pentonville_Road.jpg")

# Example longitude and latitude data
data <- data.frame(
  longitude = c(-0.127230, -0.088030, -0.102440, -0.126710, -0.175380, -0.114310),  # Example longitude values
  latitude = c(51.507542, 51.513721, 51.507320, 51.518021, 51.558170, 51.531400)   # Example latitude values
)
