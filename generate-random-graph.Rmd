...
Include dropdown menu to display markers:
```{r}
library(shiny)
library(leaflet)
...
# Example longitude and latitude data
data <- data.frame(
  longitude = c(-0.127230, -0.088030, -0.102440, -0.126710, -0.175380, -0.114310, -0.141520, -0.077990, -0.092120, -0.269540, -0.059140, -0.107450, -0.159600, -0.092750, -0.025530),  # Example longitude values
  latitude = c(51.507542, 51.513721, 51.507320, 51.518021, 51.558170, 51.531400, 51.508671, 51.532822, 51.515202, 51.488010, 51.440540, 51.497452, 51.572620, 51.517460, 51.506302),   # Example latitude values
