...
m
```
Add static image as an overlay:
```{r}
library(leaflet)
#
...
customIcon <- makeIcon(
  iconUrl = "https://upload.wikimedia.org/wikipedia/commons/d/de/Galer%C3%ADa_Nacional%2C_Londres%2C_Inglaterra%2C_2014-08-07%2C_DD_035.JPG",
  iconWidth = 100, # Adjust the icon width as needed
  iconHeight = 100 # Adjust the icon height as needed
)
