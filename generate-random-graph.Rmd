...
ui <- fluidPage(
  ...
  fluidRow(
    column(
      width = 3,
      selectInput("ac_filter", "Select AC Facilities:",
                  choices = c("All", "With AC"),
                  selected = "All"
      )
    ),
    column(
